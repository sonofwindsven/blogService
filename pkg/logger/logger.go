...
func (l *Logger) Debugf(message string, v ...interface{}) {
	l.WithLevel(LevelDebug).Output(fmt.Sprintf(message, v...))
}
...
func (l *Logger) Infof(message string, v ...interface{}) {
	l.WithLevel(LevelInfo).Output(fmt.Sprintf(message, v...))
}
...
func (l *Logger) Warnf(message string, v ...interface{}) {
	l.WithLevel(LevelWarn).Output(fmt.Sprintf(message, v...))
}
...
func (l *Logger) Errorf(message string, v ...interface{}) {
	l.WithLevel(LevelError).Output(fmt.Sprintf(message, v...))
}
...
func (l *Logger) Fatalf(message string, v ...interface{}) {
	l.WithLevel(LevelFatal).Output(fmt.Sprintf(message, v...))
}

func (l *Logger) Pannic(v ...interface{}) {
	l.WithLevel(LevelPanic).Output(fmt.Sprint(v...))
}

func (l *Logger) Panicf(message string, v ...interface{}) {
	l.WithLevel(LevelPanic).Output(fmt.Sprintf(message, v...))
}
